...
# define ball behavior when hitting walls
def ball_wall_behavior():
    ...
    # if the ball hits a vertical side wall the game ends
...
# define ball behavior when hitting walls
def ball_paddle_behavior():
    global ball_x, ball_y, BALL_RADIUS, X_BALL_INCREMENT, right_paddle_x, right_paddle_y, left_paddle_x, left_paddle_y, PADDLE_HEIGHT, PADDLE_WIDTH
